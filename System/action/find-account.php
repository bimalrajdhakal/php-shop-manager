...
$messagetosent = "Your username is <b>$myusername</b> and password is <b>$mypassword</b><br>Enjoy Shop Manager System<br>
Bimal Dhakal
<br>";
...
$mail->setFrom('bimal.raj496@gmail.com', 'Bimal Dhakal');
$mail->addAddress($usermail, $user_fullname);     
$mail->addReplyTo('bimal.raj496@gmail.com', 'Reply');
...
$mail->Password = 'bimal@123';                       
$mail->SMTPSecure = 'tls';                           
$mail->Port = 587;                                   

$mail->setFrom('shopmanagerv2.0@gmail.com', 'Bimal Dhakal');
$mail->addAddress($usermail, $user_fullname);     
$mail->addReplyTo('bimal.raj496@gmail.com', 'Reply');
$mail->addCC('cc@example.com');
$mail->addBCC('bcc@example.com');
